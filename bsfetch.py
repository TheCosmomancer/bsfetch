...
def get_logo(name, max_width, max_height):
    ...
    def _get_logo_path(name):
        ...
        LOGO_DIR = environ.get(
            "BSFETCH_LOGO_DIR",
            join(dirname(abspath(__file__)), '..', 'share', 'bsfetch', 'logo')
        )
...
def run(TO_PRINT, username_AT_networking_host_name, COLOR_PREFIX, COLOR_SUFFIX, DISPLAY_LOGO, max_width, max_height):
...
def main():
    ...
    if args.test is None:
        ...
        run(TO_PRINT=TO_PRINT, username_AT_networking_host_name=username_AT_networking_host_name, COLOR_PREFIX=COLOR_PREFIX, COLOR_SUFFIX=COLOR_SUFFIX, DISPLAY_LOGO=DISPLAY_LOGO, max_width=max_width, max_height=max_height)
